...
class ImageTest < ActiveSupport::TestCase
  test 'should create by hash' do
    ...
    images = nil
    assert_difference('Media::Image.count', imgs.length,
                      "Didn't create new images") do
  ...
  test 'should not return duplicate url' do
    ...
    assert_difference('Media::Image.count', imgs.length - 1,
                      "Didn't create correct images") do
