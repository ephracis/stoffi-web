...
ActiveRecord::Schema.define(version: 20160105205858) do
  ...
  add_index "devices", ["slug", "user_id"], name: "index_devices_on_slug_and_user_id", unique: true
  ...
  add_index "playlists", ["slug", "user_id"], name: "index_playlists_on_slug_and_user_id", unique: true
