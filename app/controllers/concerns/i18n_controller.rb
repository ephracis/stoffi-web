...
module I18nController
  ...
  included do
    ...
    def set_locale
      l = extract_locale
      @parsed_locale = l ? l.to_sym : nil
      @parsed_locale = nil if @parsed_locale &&
    ...
    # (like http://it.application.local:3000)
    #
    # You have to put something like:
    ...
    def extract_locale_from_accept_language_header
      ...
      if l
        parsed_locale = l.scan(/^[a-z]{2}[-_]([a-zA-Z]{2})/).first.first.to_s
                         .downcase
        if parsed_locale &&
