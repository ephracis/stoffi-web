...
class AppsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @app.update_attributes(app_params)
        ...
        format.js { render partial: 'shared/dialog/errors',
  ...
  def set_app
    not_found('app') and return unless App.exists? params[:id]
  ...
  def app_params
    params.require(:app).permit(:name, :website, :support_url, :callback_url,
      :icon_16, :icon_64, :icon_512, :description, :author, :author_url)
  end
