...
module Media
  class ImagesController < ApplicationController
    ...
    def update
      respond_to do |format|
        if @image.update(image_params)
          format.html { redirect_to @image.resource, flash: { success: t('media.images.update.success') }  }
    ...
    def destroy
      ...
      @image.destroy
      respond_to do |format|
        format.html { redirect_to resource, flash: { success: t('media.images.delete.success') }  }
    ...
    def set_resource
      not_found('image') and return unless Image.exists? params[:id]
