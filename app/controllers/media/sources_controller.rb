  ...
  class SourcesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @source.save
          format.html { redirect_to @source.resource, flash: { success: t('media.sources.create.success') }  }
    ...
    def update
      respond_to do |format|
        if @source.update(source_params)
          format.html { redirect_to @source.resource, flash: { success: t('media.sources.update.success') }  }
    ...
    def destroy
      ...
      @source.destroy
      respond_to do |format|
        format.html { redirect_to resource, flash: { success: t('media.sources.delete.success') }  }
