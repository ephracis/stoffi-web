...
module WidgetsHelper
  ...
  def soundcloud_widget(username, _options = {})
    raw("<div class='center'>
    <a href='https://soundcloud.com/#{username}' style=\"text-align: left; "\
    'display: block; margin: 0 auto; width: 160px; height: 92px;'\
    'font-size: 11px; padding: 68px 0 0 0; background: transparent '\
    'url(http://a1.sndcdn.com/images/badges/imonsc/square/blue.png?c052af5)'\
    'top left no-repeat; color: #ffffff; text-decoration: none; font-family: '\
    "'Lucida Grande', Helvetica, Arial, sans-serif; line-height: 1.3em; "\
    "text-align: center; outline: 0;\" class='soundcloud-badge'>"\
    "http://soundcloud.com/<span style='display: block; width: 137px; "\
    'height: 20px; margin: 0px 0 0 12px; overflow: hidden; -o-text-overflow: '\
    "ellipsis; text-overflow: ellipsis'>#{username}</span></a>
    </div>")
  end
end
